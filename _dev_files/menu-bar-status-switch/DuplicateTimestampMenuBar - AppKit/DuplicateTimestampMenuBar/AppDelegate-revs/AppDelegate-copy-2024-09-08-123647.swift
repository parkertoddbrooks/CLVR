...
class AppDelegate: NSObject, NSApplicationDelegate, NSMenuDelegate {
    ...
    func createSettingsWindow() -> NSWindow {
        ...
        let mainContainer = NSView(frame: NSRect(x: 20, y: 20, width: 560, height: 200))
        ...
        window.setContentSize(NSSize(width: 600, height: 240))
        window.minSize = NSSize(width: 600, height: 240)
        window.maxSize = NSSize(width: 600, height: 240)
