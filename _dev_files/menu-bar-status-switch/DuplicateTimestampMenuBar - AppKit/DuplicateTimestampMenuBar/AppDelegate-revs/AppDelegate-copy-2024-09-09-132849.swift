...
class AppDelegate: NSObject, NSApplicationDelegate, NSMenuDelegate {
    ...
    func createSettingsWindow() -> NSWindow {
        ...
        yOffset -= 30
        // Date Format
        let dateFormatLabel = createLabel(text: "(⌘D) file name formatting", fontSize: 13, bold: false)
       ...
       // Adjust appearance
        ...
        if let cell = dateFormatPopup.cell as? NSPopUpButtonCell {
            cell.attributedTitle = NSAttributedString(string: dateFormatPopup.title, attributes: [.foregroundColor: NSColor.labelColor])
        }
