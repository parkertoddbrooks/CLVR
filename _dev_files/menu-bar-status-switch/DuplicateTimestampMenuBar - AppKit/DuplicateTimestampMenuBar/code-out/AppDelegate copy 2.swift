...
│          let customView = ToggleView(title: "Duplicate + Timestamp", isOn: isEnabled, target: self, action:                       │
...
│          } else if let range = name.range(of: "-copy-\\d{4}-\\d{2}-\\d{2}-\\d{6}(--\\d{4}-\\d{2}-\\d{2}-\\d{6})*$", options:      │
│  .regularExpression) {                                                                                                            │
...
│          alert.informativeText = "This app needs access to your Desktop and Documents folders. Please grant access in the next    │
│  dialog."                                                                                                                         │
...
│                  failureAlert.informativeText = "Failed to gain access to the Desktop and Documents folders. Please check your    │
